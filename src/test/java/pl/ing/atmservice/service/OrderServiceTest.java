...
class OrderServiceTest {
    ...
    void calculateOrderShouldReturnUniqueElementsBasedOnOrder() {
        ...
        orderService.calculateOrder(tasks).test().assertComplete().assertNoErrors().assertValueCount(2)
                .assertValueAt(0, new Order(1, 1)).assertValueAt(1, new Order(2, 1));
    }
    ...
    void calculateOrderShouldReturnOrdersBasedOnPriority() {
        ...
        orderService.calculateOrder(tasks).test().assertComplete().assertNoErrors().assertValueCount(4)
                .assertValueAt(0, new Order(1, 4)).assertValueAt(1, new Order(1, 3)).assertValueAt(2, new Order(1, 2))
    ...
    void calculateOrderShouldReturnOrdersBasedOnRegion() {
        ...
        orderService.calculateOrder(tasks).test().assertComplete().assertNoErrors().assertValueCount(4)
                .assertValueAt(0, new Order(1, 4)).assertValueAt(1, new Order(2, 3)).assertValueAt(2, new Order(3, 2))
