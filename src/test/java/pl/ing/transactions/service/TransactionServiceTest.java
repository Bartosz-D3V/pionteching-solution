...
class TransactionServiceTest {
  ...
  void processTransactionsShouldReturnAccountsFromMultipleTransactions() {
    var transaction1 =
        new Transaction(
            "32309111922661937852684864", "06105023389842834748547303", BigDecimal.valueOf(10.90));
    var transaction2 =
        new Transaction(
            "31074318698137062235845814", "66105036543749403346524547", BigDecimal.valueOf(200.90));
    var transaction3 =
        new Transaction(
            "66105036543749403346524547", "32309111922661937852684864", BigDecimal.valueOf(50.10));
    var transaction4 =
        new Transaction(
            "31074318698137062235845814", "66105036543749403346524547", BigDecimal.valueOf(100.99));
    var transaction5 =
        new Transaction(
            "06105023389842834748547303", "99105023389842834748547321", BigDecimal.valueOf(100.99));
    var transactions =
        List.of(transaction1, transaction2, transaction3, transaction4, transaction5);

    var result =
        transactionService
            .processTransactions(transactions)
            .toMap(Account::account, account -> account)
            .blockingGet();
